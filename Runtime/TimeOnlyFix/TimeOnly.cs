...
namespace System
{
          ...
          IEquatable<TimeOnly>
    {
        ...
        public TimeOnly(int hour, int minute) : this(new TimeSpan(hour, minute, 0).Ticks) { }
        ...
        public TimeOnly(int hour, int minute, int second) : this(new TimeSpan(hour, minute, second).Ticks) { }
        ...
        public TimeOnly(int hour, int minute, int second, int millisecond) : this(new TimeSpan(0, hour, minute, second, millisecond).Ticks) { }
        ...
        public TimeOnly(long ticks)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(ticks), $"{nameof(TimeOnly)} received bad amount of ticks.");
            }
        ...
        public int CompareTo(object? value)
        {
            ...
            {
                throw new ArgumentException($"Argument must be {typeof(TimeOnly)}");
            }
        ...
        /// <remarks>The accepted standard formats are 'r', 'R', 'o', 'O', 't' and 'T'. </remarks>
        public string ToString(string? format, IFormatProvider? provider) => ToTimeSpan().ToString(format, provider);
    }
}
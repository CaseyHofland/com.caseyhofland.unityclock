...
float4 _UnityClock_Clock_Time;
float _UnityClock_Clock_Interpolant;
float _UnityClock_Clock_PingPong;

void ClockValues_float(out float4 time, out float interpolant, out float pingPong)
{
...
void ClockValues_half(out float4 time, out half interpolant, out half pingPong)
{
	time = _UnityClock_Clock_Time;
	interpolant = _UnityClock_Clock_Interpolant;
	pingPong = _UnityClock_Clock_PingPong;
